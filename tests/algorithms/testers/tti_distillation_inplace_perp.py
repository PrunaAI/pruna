...
from pruna.algorithms.distillation_perp import TextToImageInPlacePERPDistillation
...
@pytest.mark.slow
class TestTTIDistillationInPlacePerp(AlgorithmTesterBase):
    """Test the TTI Distillation InPlace Perp recovery algorithm."""

    models = ["flux_tiny_random", "sd_tiny_random", "sana_tiny_random"]
    reject_models = ["opt_125m"]
    metrics = ["cmmd"]
    allow_pickle_files = True
    algorithm_class = TextToImageInPlacePERPDistillation
