...
from pruna.algorithms.perp import TextToTextLoRA
...
@pytest.mark.slow
class TestTTTLoRA(AlgorithmTesterBase):
    """Test the TTT LoRA recovery algorithm."""

    models = ["noref_opt_tiny_random"]
    reject_models = ["sd_tiny_random"]
    allow_pickle_files = True
    algorithm_class = TextToTextLoRA
    metrics = ["perplexity"]
