...
from pruna.algorithms.perp import TextToTextPERP
...
@pytest.mark.slow
class TestTTTPerp(AlgorithmTesterBase):
    """Test the TTT Perp recovery algorithm."""

    models = ["noref_opt_tiny_random"]
    reject_models = ["sd_tiny_random"]
    allow_pickle_files = True
    algorithm_class = TextToTextPERP
    metrics = ["perplexity"]
