...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("llama_3_8b", dict(quantizer="gptq", compiler="torch_compile"), True),
        ("llama_3_8b", dict(quantizer="llm_int8", compiler="torch_compile", torch_compile_fullgraph=False), True),
    ],
