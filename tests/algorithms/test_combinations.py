...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("sd_tiny_random", dict(quantizer="diffusers_int8", compiler="torch_compile", torch_compile_fullgraph=False), False, 'cmmd'),
        pytest.param("llama_3_2_1b", dict(quantizer="gptq", compiler="torch_compile", torch_compile_fullgraph=False), True, 'perplexity', marks=pytest.mark.high),
        ("llama_3_tiny_random", dict(quantizer="llm_int8", compiler="torch_compile", torch_compile_fullgraph=False), True, 'perplexity'),
