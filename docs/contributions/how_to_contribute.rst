...
- Have a question? Discuss with us on `Discord <https://discord.gg/JFQmtFKCjdd9>`_ or check out the :doc:`/resources/faq`
- Have an idea for a new tutorial? Open an issue with a :ref:`feature-request` or chat with us on `Discord <https://discord.gg/JFQmtFKCjdd9>`_
...
If there are any questions along the way, please do not hesitate to reach out on `Discord <https://discord.gg/JFQmtFKCjdd9>`_.
