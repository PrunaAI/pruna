...
def get_metrics(request: str | List[str | BaseMetric | StatefulMetric]) -> List[BaseMetric | StatefulMetric]:
    ...
    if isinstance(request, List):
        if all(isinstance(item, BaseMetric | StatefulMetric) for item in request):
            ...
            pruna_logger.error("List must contain either all strings or all BaseMetric or StatefulMetric instances.")
            raise ValueError("List must contain either all strings or all BaseMetric or StatefulMetric instances.")
    else:
