...
class BenchmarkRegistry:
    ...
    Each entry's ``metrics`` lists ``MetricRegistry`` names with a direct counterpart
    in the reference paper when available; otherwise the list is empty. Paper notes:

    - Parti Prompts (2206.10789): human side-by-side only on P222.
    - DrawBench (2205.11487): human raters only; COCO uses FID + CLIP.
    - GenAI Bench (2406.13743): VQAScore only.
    - VBench (2311.17982): 16 dimension-specific methods; no single Pruna metric.
    - GenEval (2310.11513): Mask2Former + CLIP color pipeline, binary score.
    - Long Text Bench (2507.22058): word accuracy (X-Omni); not wired yet.
    - GEditBench (2504.17761): VIEScore via GPT-4.1/Qwen2.5-VL.
    - OneIG (2506.07977): alignment, text, reasoning metrics.
    - DPG (2403.05135): DSG-style graph score.
    """
