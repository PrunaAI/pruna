...
for _benchmark in [
    ...
    Benchmark(
        ...
        description=(
            ...
            "Evaluated with VIEScore (semantic + quality geometric mean). "
            "Note: Full parity with reference VIEScore pipelines that condition on a source image "
            "requires dataset fields and metric extensions not included here. "
            "The current implementation scores the edited image against the editing instruction only."
        ),
