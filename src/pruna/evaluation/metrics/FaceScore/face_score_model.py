...
class FaceScore(nn.Module):
    ...
    def get_reward(self, face_path: str, threshold: float = 0.9) -> tuple[list, list, list]:
        ...
        Args:
            face_path (str): Path to the image file.
            threshold (float, optional): Confidence threshold for face detection. Defaults to 0.9.

        Returns:
            tuple[list, list, list]: (rewards, boxes, confidences)
        """
